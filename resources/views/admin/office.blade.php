    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                >
                    <i class="mdi mdi-plus-circle"></i> Add Office
                </button>
                <h4 class="header-title mb-4">Manage Offices</h4>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="javascript:void(0);" 
                                            data-route="{{ route("admin.offices.show", $item->id) }}" 
...
@include("admin.modal.office.add")
@include("admin.modal.office.edit")
